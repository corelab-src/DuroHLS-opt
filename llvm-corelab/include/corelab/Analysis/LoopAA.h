...
#ifndef LLVM_CORELAB_LOOP_AA_H
#define LLVM_CORELAB_LOOP_AA_H
...
namespace corelab
{
  ...
  public:
    ...
    virtual const char *getLoopAAName() const = 0;
    ...
    /// Get a handle to the TargetData object.
    const DataLayout *getTargetData() const;
  ...
  class NoLoopAA : public LoopAA, public ImmutablePass
  {
  public:
    static char ID;
    NoLoopAA();
    ...
    virtual const char *getLoopAAName() const { return "NoLoopAA"; }
  ...
  public:
    ...
    virtual const char *getLoopAAName() const { return "AAToLoopAA"; }
