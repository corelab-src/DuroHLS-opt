...
///  Default constructor
PointerAnalysisTest::PointerAnalysisTest()
{
 ...
 */
void PointerAnalysisTest::addAddr(int A, int B)
{
 ...
 * Add a constraint of type: A = B
 */
void PointerAnalysisTest::addBase(int A, int B)
{
 ...
 * Add a constraint of type: *A = B
 */
void PointerAnalysisTest::addStore(int A, int B)
{
 ...
 * Add a constraint of type: A = *B
 */
void PointerAnalysisTest::addLoad(int A, int B)
{
 ...
 *   pointsTo(A) = {B1, B2, ...}
 */
std::set<int> &PointerAnalysisTest::pointsTo(int A) {
	if (debug)
 ...
 */
void PointerAnalysisTest::addNode(int id)
{
 ...
 */
void PointerAnalysisTest::addEdge(int fromId, int toId)
{
 ...
 */
void PointerAnalysisTest::addToPts(int pointed, int pointee)
{
...
void PointerAnalysisTest::cycleSearch(int source, int target) {
 ...
 */
void PointerAnalysisTest::merge(int id, int target)
{
...
bool PointerAnalysisTest::comparePts(int a, int b) {
 ...
 */
void PointerAnalysisTest::solve(bool withCycleRemoval)
{
	numMerged = 0;
	numCallsRemove = 0;
...
//		while (Z != from[Node].end() ) 
		...
		if (debug) std::cerr << "ACTUAL COUNT " << count << "\n";
		if ( count != count_max )
			std::cerr << "DIFF\n";
...
void PointerAnalysisTest::print(raw_ostream &O) {
	O << "# of Vertices: ";
	O << vertices.size() << "\n";
	IntSet::iterator it;
	IntMap::iterator v;
...
void PointerAnalysisTest::printDot(std::ostream& output, std::string graphName,
...
DenseMap<int, std::set<int>> &PointerAnalysisTest::allPointsTo() {
	return pointsToSet;
}
...
int PointerAnalysisTest::getNumOfMertgedVertices() {
	return numMerged;
}

// ============================================= //

int PointerAnalysisTest::getNumCallsRemove() {
	return numCallsRemove;
}

// ============================================= //

int PointerAnalysisTest::getNumVertices() {
